...
DESCRIPTION="IntelliJ IDEA Community Program"
...
# Define the version
S="${WORKDIR}/idea-IC-242.20224.300"
...
src_install() {
    ...
    make_wrapper "${P}" "${dir}/bin/idea.sh"
   	make_desktop_entry ${P} "IntelliJ IDEA Community" "${P}" "Development;IDE"
}

# Ensure proper cleanup
pkg_postinst() {
    elog "IntelliJ IDEA Community has been installed."
